...
// Refunds
Route::get('/getRefund/{id}', [RefundsController::class, 'getRefundDetails']); // Truyền ID của order hoàn tiền vô :3
Route::post('/createRefund/{id}', [RefundsController::class, 'createRefund']); // Truyền ID của order hoàn tiền vô :3
Route::post('/approveRefund', [RefundsController::class, 'approveRefund']);
// Route::post('/checkham/{id}', [RefundsController::class, 'IsOwnerShop']);
