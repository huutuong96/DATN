...
Route::group(['middleware' => ['checkToken', 'CheckRole']], function () {
    ...
    Route::get('/trash-stores', [VnshopController::class, 'trash_stores'])->name('trash_stores')->middleware('CheckAdminPremission:manage_storestore');;
    ...
    Route::get('/trash-category', [VnshopController::class, 'trash_category'])->name('trash_category')->middleware('CheckAdminPremission:manage_category');
    Route::get('/change-category', [VnshopController::class, 'changeCategory'])->name('change_category')->middleware('CheckAdminPremission:manage_category');
    Route::get('/change-shop', [VnshopController::class, 'changeShop'])->name('change_shop')->middleware('CheckAdminPremission:manage_category');
    Route::get('/change-shop-search', [VnshopController::class, 'changeShopSearch'])->name('changeShopSearch')->middleware('CheckAdminPremission:manage_store');
    Route::get('/list_role', [VnshopController::class, 'list_role'])->name('list_role');
    Route::get('/product_all', [ProductController::class, 'ProductAll'])->name('product_all')->middleware('CheckAdminPremission:manage_product');
    Route::get('/product-waiting-approval', [ProductController::class, 'productWaitingApproval'])->name('product-waiting-approval')->middleware('CheckAdminPremission:manage_product');
    Route::post('/products/{id}/approve', action: [ProductController::class, 'approveProduct'])->name('products.approve')->middleware('CheckAdminPremission:manage_product');
    Route::post('/products/{id}/reject', [ProductController::class, 'rejectProduct'])->name('products.reject')->middleware('CheckAdminPremission:manage_product');
    Route::get('/products/report/{id}', [ProductController::class, 'showReportForm'])->name('products.report')->middleware('CheckAdminPremission:manage_product');
    Route::post('/products/report/{id}', [ProductController::class, 'reportProduct'])->name('products.submitReport')->middleware('CheckAdminPremission:manage_product');
    Route::get('/list_permission', [VnshopController::class, 'list_permission'])->name('list_permission');
    Route::delete('/blogs/{id}', [BlogsController::class, 'destroy'])->name('blogs.destroy')->middleware('CheckAdminPremission:manage_blog');
    Route::put('/blogs/{id}', [VnshopController::class, 'updateBlog'])->name('blogs.update')->middleware('CheckAdminPremission:manage_blog');
    Route::post('/blogs/{id}/restore', [VnshopController::class, 'restoreBlog'])->name('blogs.restore')->middleware('CheckAdminPremission:manage_blog');
    Route::put('/posts/{id}', [VnshopController::class, 'updatepost'])->name('post.update')->middleware('CheckAdminPremission:manage_post');
    Route::delete('/post/{id}', [PostController::class, 'destroy'])->name('post.destroy')->middleware('CheckAdminPremission:manage_post');
    Route::post('/post/{id}/restore', [VnshopController::class, 'restorepost'])->name('post.restore')->middleware('CheckAdminPremission:manage_post');
    ...
    Route::put('/config_update/{id}', [configController::class, 'update'])->name('config.update')->middleware('CheckAdminPremission:manage_web_information');
    Route::get('/voucherall', [VoucherToMainController::class, 'voucherall'])->name('voucherall');
    Route::put('/update_voucher/{id}', [VnshopController::class, 'updatevoucher'])->name('voucher_main.update')->middleware('CheckAdminPremission:manage_voucher');
    Route::delete('/delete_voucher/{id}', [VnshopController::class, 'delete_voucher'])->name('voucher.delete')->middleware('CheckAdminPremission:manage_voucher');
    Route::get('/taxall', [VnshopController::class, 'taxall'])->name('taxall')->middleware('CheckAdminPremission:manage_tax');
    Route::put('/update_tax/{id}', [VnshopController::class, 'update_tax'])->name('tax.update')->middleware('CheckAdminPremission:manage_tax');
    Route::post('/storetax', [VnshopController::class, 'storetax'])->name('tax.store')->middleware('CheckAdminPremission:manage_tax');
    Route::delete('/destroytax/{id}', [VnshopController::class, 'destroytax'])->name('tax.delete')->middleware('CheckAdminPremission:manage_tax');
    Route::get('/changeStatusTax/{id}', [VnshopController::class, 'changeStatusTax'])->name('changeStatusTax')->middleware('CheckAdminPremission:manage_tax');
    Route::get('/bannerall', [VnshopController::class, 'bannerall'])->name('bannerall');
    Route::post('/storebanner', [VnshopController::class, 'storebanner'])->name('banner.store')->middleware('CheckAdminPremission:manage_banner');
    Route::put('/bannerupdate{id}', [VnshopController::class, 'updatebanner'])->name('banner.update')->middleware('CheckAdminPremission:manage_banner');
    ...
    Route::post('categories', [VnshopController::class, 'storeCategory'])->name('create_category')->middleware('CheckAdminPremission:manage_category');
    Route::put('categories', [VnshopController::class, 'updateCategory'])->name('update_category')->middleware('CheckAdminPremission:manage_category');
    ...
    Route::get('/setting_admin', [webAppController::class, 'setting_admin'])->name('setting_admin');   // bawts phari l;af onew
    ...
    Route::post('/rankCreate', [VnshopController::class, 'rankCreate'])->name('rankCreate')->middleware('CheckAdminPremission:manage_rank');
    Route::put('/update_rank/{id}', [VnshopController::class, 'updaterank'])->name('rank.update')->middleware('CheckAdminPremission:manage_rank');
    Route::get('/changeStatusRank/{id}', [VnshopController::class, 'changeStatusRank'])->name('changeStatusRank')->middleware('CheckAdminPremission:manage_rank');
    Route::delete('/destroyrank/{id}', [VnshopController::class, 'destroyrank'])->name('rank.delete')->middleware('CheckAdminPremission:manage_rank');
    Route::get('/changeStatusBanner/{id}', [VnshopController::class, 'changeStatusBanner'])->name('changeStatusBanner')->middleware('CheckAdminPremission:manage_bannerbanner');
    Route::get('/payment_method', [VnshopController::class, 'payment_method'])->name('payment_method');
    Route::post('/storepaymant', [VnshopController::class, 'storepaymant'])->name('storepaymant')->middleware('CheckAdminPremission:manage_payment_method');
    Route::put('/payment_methodupdate/{id}', [VnshopController::class, 'updatepayment'])->name('updatepayment')->middleware('CheckAdminPremission:manage_payment_method');
    Route::get('/changeStatuspayment/{id}', [VnshopController::class, 'changeStatuspayment'])->name('changeStatuspayment')->middleware('CheckAdminPremission:manage_payment_method');
    Route::delete('/destroypayment/{id}', [VnshopController::class, 'destroypayment'])->name('destroypayment')->middleware('CheckAdminPremission:manage_payment_method');
    Route::post('products/update/handle/{id}', [VnshopController::class, 'handleUpdateProduct'])->name('handleUpdateProduct')->middleware('CheckAdminPremission:manage_productproduct');
