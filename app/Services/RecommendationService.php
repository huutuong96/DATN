...
class RecommendationService
{
    ...
    // public function recommendTopN(array $userVector, array $trainingData, array $labels, int $n, $userPurchasedProducts)
    // {
    //     $categoriesForProductWhenUserPurchased = Product::whereIn('id', $userPurchasedProducts)->pluck('category_id')->toArray();
    //     $mostPurchasedCategory = array_count_values($categoriesForProductWhenUserPurchased);
    //     arsort($mostPurchasedCategory);
    //     $mostPurchasedCategory = array_key_first($mostPurchasedCategory);
