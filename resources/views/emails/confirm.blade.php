...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <main style="padding: 20px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ route('confirm', ['token' => $token]) }}" style="background-color: #4CAF50; color: white; padding: 14px 20px; text-align: center; text-decoration: none; display: inline-block; border-radius: 4px; font-size: 16px;">Xác nhận đăng ký tài khoản</a>
        </div>
