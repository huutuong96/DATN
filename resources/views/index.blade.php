                        ...
                        <div class="d-flex align-items-center">
                            ...
                            >
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a
                                        class="dropdown-item"
                                        href="{{ route('adminLogout', ['token' => session()->token()]) }}"
                                        ><i
                    ...
                    >
                        <span class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-start">
                                <span
                                    class="d-block fw-medium sidebar-user-name-text"
                                    >Anna Adame</span
                                >
                                <span
                                    class="d-block fs-14 sidebar-user-name-sub-text"
                                    ><i
