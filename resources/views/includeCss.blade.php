...
<head>
    ...
    <!-- jsvectormap css -->
    <link href="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/libs/jsvectormap/css/jsvectormap.min.css" rel="stylesheet" type="text/css" />
    <!--Swiper slider css-->
    <link href="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <!-- apexcharts -->
    <script src="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/libs/apexcharts/apexcharts.min.js"></script>

    <!-- Vector map-->
    <script src="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/libs/jsvectormap/js/jsvectormap.min.js"></script>
    <script src="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/libs/jsvectormap/maps/world-merc.js"></script>

    <!--Swiper slider js-->
    <script src="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/libs/swiper/swiper-bundle.min.js"></script>

    <!-- Dashboard init -->
    <script src="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/js/pages/dashboard-ecommerce.init.js"></script>

    <script src="{{env('URL_CSS') ?? env('URL_CSS_PRODUCTION')}}assets/js/app.js"></script>
</body>
