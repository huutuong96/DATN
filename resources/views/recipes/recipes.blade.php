                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-auto ms-auto">
                                    <div class="d-flex hastck gap-2 flex-wrap">
                                        ...
                                        <button data-bs-toggle="modal" data-bs-target="#adddeals" class="btn btn-success"><i class="ri-add-fill align-bottom me-1"></i>Thêm công thức</button>
                                        <div class="dropdown">
...
<div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        <div class="col">
                            ...
                            <div class="collapse show" id="leadDiscovered">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center collapsed" data-bs-toggle="collapse" href="#leadDiscovered4" role="button" aria-expanded="false" aria-controls="leadDiscovered4">
                                            <div class="flex-shrink-0">
                                    ...
                                    <div class="border-top border-top-dashed collapse" id="leadDiscovered4" style="">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge bg-danger-subtle text-danger">4 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated5" role="button" aria-expanded="false" aria-controls="contactInitiated5">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/brands/mail_chimp.png" alt="" class="avatar-xs rounded-circle material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified3" role="button" aria-expanded="false" aria-controls="needsIdentified3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/brands/dribbble.png" alt="" class="avatar-xs rounded-circle material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6" role="button" aria-expanded="false" aria-controls="needsIdentified6">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/companies/img-6.png" alt="" class="avatar-xs rounded-circle material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1" role="button" aria-expanded="false" aria-controls="meetingArranged1">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/companies/img-5.png" alt="" class="avatar-xs rounded-circle material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged3" role="button" aria-expanded="false" aria-controls="meetingArranged3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/companies/img-8.png" alt="" class="avatar-xs rounded-circle material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5" role="button" aria-expanded="false" aria-controls="offerAccepted5">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/companies/img-3.png" alt="" class="avatar-xs rounded-circle material-shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-light p-3">
                                    <h5 class="modal-title" id="exampleModalLabel">Tạo công thức</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form action="{{ route('recipesCreate', ['token' => auth()->user()->refesh_token]) }}" method="POST">
                                   @csrf
                                    <div class="modal-body ">
                                        <div class="mb-3">
                                            <label for="dealTitle" class="form-label">Tên công thức</label>
                                            <input name="title" type="text" class="form-control" id="dealTitle" placeholder="Enter title" required="">
                                            <div class="invalid-feedback">
                                                Vui lòng nhập Tên công thức
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="dealValue" class="form-label">CODE</label>
                                            <input name="code" type="text" class="form-control" id="dealValue" step="0.01" placeholder="Enter value" required="">
                                            <div class="invalid-feedback">
                                                Vui lòng nhập CODE
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="dealOwner" class="form-label">TYPE</label>
                                            <input name="type" type="text" class="form-control" id="dealOwner" required="" placeholder="Enter owner name">
                                            <div class="invalid-feedback">
                                                Vui lòng nhập TYPE
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="dueDate" class="form-label">Mô tả</label>
                                            <input name="description" type="text" class="form-control" id="dueDate" data-provider="flatpickr" placeholder="Select date" required="">
                                            <div class="invalid-feedback">
                                                Vui lòng nhập mô tả
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="dealEmail" class="form-label">Công thức</label>
                                            <textarea name="json" class="form-control" id="contactDescription" rows="3" placeholder="Enter description" required=""></textarea>
                                            <div class="invalid-feedback">
                                                Công thức tính ( JSON )
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-light" id="close-modal" data-bs-dismiss="modal">Hủy</button>
                                        <button type="submit" class="btn btn-success"><i class="ri-save-line align-bottom me-1"></i> Thêm</button>
                                    </div>
                                </form>
                            </div>
                        </div>
